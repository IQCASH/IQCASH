...
In order to support loading of multiple wallets in iqcash-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is iqcash.cpp.
...
Changes to iqcash.cpp
----------------------
iqcash.cpp is the entry point into iqcash-qt, and as such, will require some minor modifications to provide hooks for
