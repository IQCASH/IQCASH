                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("IQCash Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a IQCash address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and iqcash: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About IQCash Core"), this);
    aboutAction->setStatusTip(tr("Show information about IQCash Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for IQCash"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your IQCash addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified IQCash addresses"));
    ...
    openAction->setStatusTip(tr("Open a IQCash: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the IQCash Core help message to get a list with possible IQCash command-line options"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to IQCash network", "", count));
}
