...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizeIQCashAmount"))
        settings.setValue("nAnonymizeIQCashAmount", 1000);

    nAnonymizeIQCashAmount = settings.value("nAnonymizeIQCashAmount").toLongLong();
...
QVariant OptionsModel::data(const QModelIndex& index, int role) const
{
    if (role == Qt::EditRole) {
        ...
        case AnonymizeIQCashAmount:
            return QVariant(nAnonymizeIQCashAmount);
        case Listen:
...
bool OptionsModel::setData(const QModelIndex& index, const QVariant& value, int role)
{
    ...
    if (role == Qt::EditRole) {
        ...
        case AnonymizeIQCashAmount:
            nAnonymizeIQCashAmount = value.toInt();
            settings.setValue("nAnonymizeIQCashAmount", nAnonymizeIQCashAmount);
            emit anonymizeIQCashAmountChanged(nAnonymizeIQCashAmount);
            break;
        case CoinControlFeatures:
