...
QT_TRANSLATE_NOOP("iqcash-core", ""
"Disable all IQCash specific functionality (Masternodes, Obfuscation, SwiftX, "
...
"hash)"),
QT_TRANSLATE_NOOP("iqcash-core", ""
"Fees (in ICS/Kb) smaller than this are considered zero fee for relaying "
"(default: %s)"),
QT_TRANSLATE_NOOP("iqcash-core", ""
"Fees (in ICS/Kb) smaller than this are considered zero fee for transaction "
"creation (default: %s)"),
QT_TRANSLATE_NOOP("iqcash-core", ""
...
QT_TRANSLATE_NOOP("iqcash-core", ""
"To use iqcashd, or the -server option to iqcash-qt, you must set an rpcpassword "
...
"transaction that are not equal 500000 ICS."),
QT_TRANSLATE_NOOP("iqcash-core", ""
...
QT_TRANSLATE_NOOP("iqcash-core", "Acceptable ciphers (default: %s)"),
...
QT_TRANSLATE_NOOP("iqcash-core", "Already have that input."),
...
QT_TRANSLATE_NOOP("iqcash-core", "Calculating missing accumulators..."),
QT_TRANSLATE_NOOP("iqcash-core", "Can't denominate: no compatible inputs left."),
QT_TRANSLATE_NOOP("iqcash-core", "Can't find random Masternode."),
QT_TRANSLATE_NOOP("iqcash-core", "Can't mix while sync in progress."),
QT_TRANSLATE_NOOP("iqcash-core", "Cannot downgrade wallet"),
QT_TRANSLATE_NOOP("iqcash-core", "Cannot resolve -bind address: '%s'"),
QT_TRANSLATE_NOOP("iqcash-core", "Cannot resolve -externalip address: '%s'"),
QT_TRANSLATE_NOOP("iqcash-core", "Cannot resolve -whitebind address: '%s'"),
QT_TRANSLATE_NOOP("iqcash-core", "Cannot write default address"),
QT_TRANSLATE_NOOP("iqcash-core", "Collateral not valid."),
QT_TRANSLATE_NOOP("iqcash-core", "Connect only to the specified node(s)"),
...
QT_TRANSLATE_NOOP("iqcash-core", "Copyright (C) 2015-%i The PIVX Core Developers"),
QT_TRANSLATE_NOOP("iqcash-core", "Copyright (C) 2017-%i The IQCash Core Developers"),
QT_TRANSLATE_NOOP("iqcash-core", "Corrupted block database detected"),
QT_TRANSLATE_NOOP("iqcash-core", "Could not parse -rpcbind value %s as network address"),
...
QT_TRANSLATE_NOOP("iqcash-core", "Enable automatic Zerocoin minting (0-1, default: %u)"),
...
QT_TRANSLATE_NOOP("iqcash-core", "Entries are full."),
QT_TRANSLATE_NOOP("iqcash-core", "Error connecting to Masternode."),
...
QT_TRANSLATE_NOOP("iqcash-core", "Error recovering public key."),
...
QT_TRANSLATE_NOOP("iqcash-core", "Error: Can't select current denominated inputs"),
...
QT_TRANSLATE_NOOP("iqcash-core", "Error: You already have pending entries in the Obfuscation pool"),
QT_TRANSLATE_NOOP("iqcash-core", "Failed to listen on any port. Use -listen=0 if you want this."),
QT_TRANSLATE_NOOP("iqcash-core", "Failed to read block index"),
QT_TRANSLATE_NOOP("iqcash-core", "Failed to read block"),
QT_TRANSLATE_NOOP("iqcash-core", "Failed to write block index"),
QT_TRANSLATE_NOOP("iqcash-core", "Fee (in ICS/kB) to add to transactions you send (default: %s)"),
QT_TRANSLATE_NOOP("iqcash-core", "Finalizing transaction."),
QT_TRANSLATE_NOOP("iqcash-core", "Force safe mode (default: %u)"),
QT_TRANSLATE_NOOP("iqcash-core", "Found enough users, signing ( waiting %s )"),
QT_TRANSLATE_NOOP("iqcash-core", "Found enough users, signing ..."),
...
QT_TRANSLATE_NOOP("iqcash-core", "Incompatible mode."),
QT_TRANSLATE_NOOP("iqcash-core", "Incompatible version."),
...
QT_TRANSLATE_NOOP("iqcash-core", "Input is not valid."),
QT_TRANSLATE_NOOP("iqcash-core", "Insufficient funds"),
QT_TRANSLATE_NOOP("iqcash-core", "Insufficient funds."),
QT_TRANSLATE_NOOP("iqcash-core", "Invalid -onion address or hostname: '%s'"),
QT_TRANSLATE_NOOP("iqcash-core", "Invalid -proxy address or hostname: '%s'"),
QT_TRANSLATE_NOOP("iqcash-core", "Invalid amount for -maxtxfee=<amount>: '%s'"),
QT_TRANSLATE_NOOP("iqcash-core", "Invalid amount for -minrelaytxfee=<amount>: '%s'"),
QT_TRANSLATE_NOOP("iqcash-core", "Invalid amount for -mintxfee=<amount>: '%s'"),
QT_TRANSLATE_NOOP("iqcash-core", "Invalid amount for -paytxfee=<amount>: '%s' (must be at least %s)"),
QT_TRANSLATE_NOOP("iqcash-core", "Invalid amount for -paytxfee=<amount>: '%s'"),
QT_TRANSLATE_NOOP("iqcash-core", "Invalid amount for -reservebalance=<amount>"),
...
QT_TRANSLATE_NOOP("iqcash-core", "Invalid port detected in masternode.conf"),
QT_TRANSLATE_NOOP("iqcash-core", "Invalid private key."),
QT_TRANSLATE_NOOP("iqcash-core", "Invalid script detected."),
QT_TRANSLATE_NOOP("iqcash-core", "Keep at most <n> unconnectable transactions in memory (default: %u)"),
QT_TRANSLATE_NOOP("iqcash-core", "Last Obfuscation was too recent."),
QT_TRANSLATE_NOOP("iqcash-core", "Last successful Obfuscation action was too recent."),
QT_TRANSLATE_NOOP("iqcash-core", "Less than 3 mints added, unable to create spend"),
QT_TRANSLATE_NOOP("iqcash-core", "Limit size of signature cache to <n> entries (default: %u)"),
...
QT_TRANSLATE_NOOP("iqcash-core", "Loading wallet... (%3.2f %%)"),
QT_TRANSLATE_NOOP("iqcash-core", "Loading wallet..."),
QT_TRANSLATE_NOOP("iqcash-core", "Lock is already in place."),
...
QT_TRANSLATE_NOOP("iqcash-core", "Masternode queue is full."),
QT_TRANSLATE_NOOP("iqcash-core", "Masternode:"),
...
QT_TRANSLATE_NOOP("iqcash-core", "Missing input transaction information."),
QT_TRANSLATE_NOOP("iqcash-core", "Mixing in progress..."),
QT_TRANSLATE_NOOP("iqcash-core", "Need to specify a port with -whitebind: '%s'"),
QT_TRANSLATE_NOOP("iqcash-core", "No Masternodes detected."),
QT_TRANSLATE_NOOP("iqcash-core", "No compatible Masternode found."),
QT_TRANSLATE_NOOP("iqcash-core", "No funds detected in need of denominating."),
QT_TRANSLATE_NOOP("iqcash-core", "No matching denominations found for mixing."),
QT_TRANSLATE_NOOP("iqcash-core", "Node relay options:"),
QT_TRANSLATE_NOOP("iqcash-core", "Non-standard public key detected."),
QT_TRANSLATE_NOOP("iqcash-core", "Not compatible with existing transactions."),
QT_TRANSLATE_NOOP("iqcash-core", "Not enough file descriptors available."),
QT_TRANSLATE_NOOP("iqcash-core", "Not in the Masternode list."),
QT_TRANSLATE_NOOP("iqcash-core", "Number of automatic wallet backups (default: 10)"),
QT_TRANSLATE_NOOP("iqcash-core", "Obfuscation is idle."),
QT_TRANSLATE_NOOP("iqcash-core", "Obfuscation request complete:"),
QT_TRANSLATE_NOOP("iqcash-core", "Obfuscation request incomplete:"),
...
QT_TRANSLATE_NOOP("iqcash-core", "Percentage of automatically minted Zerocoin  (10-100, default: %u)"),
...
QT_TRANSLATE_NOOP("iqcash-core", "RPC SSL options: (see the Bitcoin Wiki for SSL setup instructions)"),
QT_TRANSLATE_NOOP("iqcash-core", "RPC server options:"),
QT_TRANSLATE_NOOP("iqcash-core", "RPC support for HTTP persistent connections (default: %d)"),
...
QT_TRANSLATE_NOOP("iqcash-core", "Recalculating coin supply may take 30-60 minutes..."),
QT_TRANSLATE_NOOP("iqcash-core", "Recalculating supply statistics may take 30-60 minutes..."),
QT_TRANSLATE_NOOP("iqcash-core", "Receive and display P2P network alerts (default: %u)"),
...
QT_TRANSLATE_NOOP("iqcash-core", "Server certificate file (default: %s)"),
QT_TRANSLATE_NOOP("iqcash-core", "Server private key (default: %s)"),
QT_TRANSLATE_NOOP("iqcash-core", "Session not complete!"),
QT_TRANSLATE_NOOP("iqcash-core", "Session timed out."),
...
QT_TRANSLATE_NOOP("iqcash-core", "Signing failed."),
QT_TRANSLATE_NOOP("iqcash-core", "Signing timed out."),
...
QT_TRANSLATE_NOOP("iqcash-core", "Submitted following entries to masternode: %u / %d"),
QT_TRANSLATE_NOOP("iqcash-core", "Submitted to masternode, waiting for more entries ( %u / %d ) %s"),
QT_TRANSLATE_NOOP("iqcash-core", "Submitted to masternode, waiting in queue %s"),
...
QT_TRANSLATE_NOOP("iqcash-core", "Synchronization pending..."),
...
QT_TRANSLATE_NOOP("iqcash-core", "Transaction created successfully."),
QT_TRANSLATE_NOOP("iqcash-core", "Transaction fees are too high."),
QT_TRANSLATE_NOOP("iqcash-core", "Transaction not valid."),
QT_TRANSLATE_NOOP("iqcash-core", "Transaction too large for fee policy"),
QT_TRANSLATE_NOOP("iqcash-core", "Transaction too large"),
QT_TRANSLATE_NOOP("iqcash-core", "Transmitting final transaction."),
...
QT_TRANSLATE_NOOP("iqcash-core", "Unknown state: id = %u"),
QT_TRANSLATE_NOOP("iqcash-core", "Upgrade wallet to latest format"),
QT_TRANSLATE_NOOP("iqcash-core", "Use OpenSSL (https) for JSON-RPC connections"),
...
QT_TRANSLATE_NOOP("iqcash-core", "Value more than Obfuscation pool maximum allows."),
...
QT_TRANSLATE_NOOP("iqcash-core", "Wallet is locked."),
...
QT_TRANSLATE_NOOP("iqcash-core", "Will retry..."),
QT_TRANSLATE_NOOP("iqcash-core", "You need to rebuild the database using -reindex to change -txindex"),
QT_TRANSLATE_NOOP("iqcash-core", "Your entries added successfully."),
QT_TRANSLATE_NOOP("iqcash-core", "Your transaction was accepted into the pool!"),
...
QT_TRANSLATE_NOOP("iqcash-core", "failed to validate zerocoin"),
